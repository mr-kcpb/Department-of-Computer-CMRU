        ...
        <div class="banner">
            ...
            <ul>
                ...
                <li data-transition="zoomin" data-slotamount="5">
                    <img src="{{ asset('template/img/rev-slider/3.jpg') }}" alt="" data-bgfit="cover"
                    ...
                    <div class="tp-caption lfb fadeout"
                         ...
                         data-speed="1000"
                         data-start="1000"
                         style="z-index: 2;"><img src="{{ asset('template/img/rev-slider/girl1.png') }}" alt=""/>
                    </div>
                    ...
                    <div class="tp-caption lfb fadeout"
                         ...
                         data-speed="1000"
                         data-start="1300"
                         style="z-index: 2;"><img src="{{ asset('template/img/rev-slider/girl2.png') }}" alt=""/>
                    </div>
                    ...
                    <div class="tp-caption lfb fadeout"
                         ...
                         data-speed="1000"
                         data-start="1600"
                         style="z-index: 2;"><img src="{{ asset('template/img/rev-slider/girl3.png') }}" alt=""/>
                    </div>
                    ...
                    <div class="tp-caption lfb fadeout"
                         ...
                         data-speed="1000"
                         data-start="1900"
                         style="z-index: 2;"><img src="{{ asset('template/img/rev-slider/girl4.png') }}" alt=""/>
                    </div>
                    ...
                    <div class="tp-caption lfb fadeout"
                         ...
                         data-speed="1000"
                         data-start="2200"
                         style="z-index: 2;"><img src="{{ asset('template/img/rev-slider/girl5.png') }}" alt=""/>
                    </div>
                </li>
                <!-- Slide #1 ends -->
                ...
                <li data-transition="fadefromright">
                    <img src="{{ asset('template/img/rev-slider/transparent.png') }}" class="bg-color" alt=""/>
                    ...
                    <div class="tp-caption lfb fadeout"
                         ...
                         data-speed="1000"
                         data-start="2300"
                         style="z-index: 2;"><img src="{{ asset('template/img/rev-slider/iphone1.png') }}" alt=""/>
                    </div>
                    ...
                    <div class="tp-caption lfb fadeout"
                         ...
                         data-speed="1000"
                         data-start="2600"
                         style="z-index: 1;"><img src="{{ asset('template/img/rev-slider/iphone2.png') }}" alt=""/>
                    </div>
                ...
                <li data-transition="slidedown">
                    <img src="{{ asset('template/img/rev-slider/transparent.png') }}" style="background-color:#fafafa"
                         alt=""/>
                    ...
                    <div class="tp-caption b-small-para black lfb text-center"
                         ...
                         data-speed="800"
                         data-start="2300"
                         style="z-index: 8">Lorem Ipsum is simply dummy text of the printing industry. Lorem
                        Ipsum is simply dummy text of the <br/> printing industry. Lorem Ipsum dummy printing
                        dummy industry.
                    </div>
                ...
                <li data-transition="slotslide-horizontal" data-slotamount="5">
                    ...
                    <div class="tp-caption lfb"
                         ...
                         style="z-index: 8">
                        <iframe src='https://www.youtube.com/embed/jhNszvpJxho?enablejsapi=1&amp;html5=1&amp;iv_load_policy=3&amp;hd=1&amp;wmode=opaque&amp;controls=1&amp;showinfo=0;rel=0;'
                                width='540' height='333'
                                style='width:540px;height:333px;border:0px;box-shadow:0px 0px 5px rgba(0,0,0,0.4);'></iframe>
                    </div>
                </li>
                <!-- Slide #4 ends -->
                ...
                <li data-transition="boxslide" data-slotamount="5">
                    ...
                    <img src="{{ asset('template/img/rev-slider/1.jpg') }}" alt=""/>
                    ...
                    <div class="tp-caption b-small-para black skewfromleftshort"
                         ...
                         data-speed="500"
                         data-start="1300"
                         style="z-index: 8">Lorem Ipsum is simply dummy text of the printing <br/> industry.
                        Lorem Ipsum is simply dummy text of the <br/> printing industry. Lorem Ipsum printing
                        industry.
                    </div>
                    ...
                    <div class="tp-caption lft"
                         ...
                         data-speed="800"
                         data-start="1700"
                         style="z-index: 8"><img src="{{ asset('template/img/rev-slider/brave.png') }}" alt=""/>
                    </div>
